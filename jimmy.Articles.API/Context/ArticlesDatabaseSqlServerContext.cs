...
{
    public class ArticlesDatabaseSqlServerContext : DbContext, IArticlesDatabaseContext
    {
    private IDbContextTransaction _currentTransaction;

    public ArticlesDatabaseSqlServerContext(DbContextOptions<ArticlesDatabaseSqlServerContext> options)
        : base(options)
    {
    }
